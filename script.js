...
function updateCharDisplay(pNum, char) {
    ...
    resHtml += '</div>';
    infoEl.innerHTML = `<div class="char-name">${char.name}</div><div class="char-stats">体力: ${Math.floor(char.currentHp)}/${char.maxHp} 攻撃:${char.battleAtk} 速度:${char.battleSpd}</div>${resHtml}`;
